...
TOOL_USE_ENFORCEMENT_GUIDANCE = (
    ...
    "write can be performed now. When you say you will perform an action, you MUST "
    "immediately make the corresponding tool call in the same response. Never end "
    "your turn with a promise of future action when that action is authorized now.\n"
    ...
    "Keep working until the requested task is complete within those boundaries. "
    "Every response should either make authorized progress or deliver a final result "
    "or approval-gated plan."
)
