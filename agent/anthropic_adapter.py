...
def _ignored_subscription_env_sources(explicit_api_key: Any = None) -> Tuple[str, ...]:
    ignored = []
    if explicit_api_key:
        ignored.append("explicit_api_key")
...
def resolve_anthropic_subscription_credentials(
    *, explicit_api_key: Any = None,
    ...
    """
    ignored = _ignored_subscription_env_sources(explicit_api_key)
...
def resolve_anthropic_credentials(
    *,
    ...
    if mode == ANTHROPIC_AUTH_MODE_SUBSCRIPTION_ONLY:
        return resolve_anthropic_subscription_credentials(explicit_api_key=explicit_api_key)
